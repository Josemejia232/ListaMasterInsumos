...
KEYWORDS_BD: dict[str, list[str]] = {
    ...
    "Agregado grueso": ["agregado", "grueso", "gravilla", "grava", "triturada"],
}
...
_CONCRETOS = [
    Mezcla(
        ...
        materiales=[
            ...
            MaterialReceta("Agregado grueso", "m3", 0.74, keywords=["agregado", "grueso", "gravilla"]),
    ...
    Mezcla(
        ...
        materiales=[
            ...
            MaterialReceta("Agregado grueso", "m3", 0.92, keywords=["agregado", "grueso", "gravilla"]),
    ...
    Mezcla(
        ...
        materiales=[
            ...
            MaterialReceta("Agregado grueso", "m3", 1.05, keywords=["agregado", "grueso", "gravilla"]),
    ...
    Mezcla(
        ...
        materiales=[
            ...
            MaterialReceta("Agregado grueso", "m3", 0.79, keywords=["agregado", "grueso", "gravilla"]),
